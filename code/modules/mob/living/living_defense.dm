...
/mob/living/proc/run_armor_check(def_zone = null, attack_flag = "blunt", absorb_text = null, soften_text = null, armor_penetration, penetrated_text, damage, blade_dulling, intdamfactor)
	var/armor = getarmor(def_zone, attack_flag, damage, armor_penetration, blade_dulling, intdamfactor)
...
/mob/living/proc/getarmor(def_zone, type, damage, armor_penetration, blade_dulling, intdamfactor)
	return 0
