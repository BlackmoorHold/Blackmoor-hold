...
/datum/outfit/job/roguetown/knight/heavy/pre_equip(mob/living/carbon/human/H)
	..()
	H.mind.adjust_skillrank_up_to(/datum/skill/combat/swords, 3, TRUE) //everyone knows to use swords.
	H.mind.adjust_skillrank_up_to(/datum/skill/misc/riding, 1, TRUE)	//Too heavy for horses.
	H.mind.adjust_skillrank_up_to(/datum/skill/combat/wrestling, 3, TRUE)
	H.mind.adjust_skillrank_up_to(/datum/skill/combat/unarmed, 3, TRUE)
	H.mind.adjust_skillrank_up_to(/datum/skill/misc/climbing, 1, TRUE) //why can they climb?
...
/datum/advclass/knight/footknight
	name = "Foot Knight"
	tutorial = "You are accustomed to traditional foot-soldier training in one-handed weapons such as flails, swords, and maces. Your fortitude and mastery with the combination of a shield and weapon makes you a fearsome opponent to take down!"
...
/datum/outfit/job/roguetown/knight/irregularknight/pre_equip(mob/living/carbon/human/H)
	...
	//8 points due medium- armor compared to rest.
