...
#define TRAIT_LORDLESS "Lordless" //Knight has lost their liege
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_LORDLESS = span_warning("My liege has fallen! I feel weakened until a new ruler is crowned.")
))
